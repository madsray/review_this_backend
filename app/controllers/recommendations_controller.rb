class RecommendationsController < ApplicationController
  ...
  def index
    ...
    render json: @recommendations.to_json(include: [:movie, :review])
  end

  # GET /recommendations/1
  def show
    render json: @recommendation.to_json(include: [:movie, :review])
  end
  ...
  private
    ...
    def recommendation_params
      params.require(:recommendation).permit(:movie_id, :review_id)
    end
end
