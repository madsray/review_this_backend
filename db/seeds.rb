...
Review.create([
{title:'Wine', content:'Wine, Wine, and more wine. I mean does anyone watch 50 shades as they are eating dinner. So our pairing here is simply a bottle of wine.' , rating:5, movie_id:2},
{title:'Cheese Fries', content:'Act like it is Wednesday, wear pink, and just make the decision to get cheese fries because apparently that only has 30% calories from fat.' , rating:4, movie_id:1},
{title:'Meat Patty and Stale Bread', content:'If you have ever read the books you know that these are common foods for the Dauntless ' , rating:1, movie_id:8},
{title:'Veal Parm', content:'Need I say More?', rating:5, movie_id:5},
{title:'A hamburger', content:'Just thinking of Disney World and the jurassic land sells a lot of hamburgers' , rating:2, movie_id:3}
]);
